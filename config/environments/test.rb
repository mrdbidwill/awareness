...
Rails.application.configure do
  ...
  # Test keys for Active Record encryption / devise-two-factor encrypted attributes.
  ...
  config.active_record.encryption.key_derivation_salt =
    ENV.fetch("ACTIVE_RECORD_ENCRYPTION_KEY_DERIVATION_SALT", "test-key-derivation-salt-1234567890")
